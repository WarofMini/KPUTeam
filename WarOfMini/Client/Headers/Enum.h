...
enum MESHNUM { MESHNUM_PLAYER, MESHNUM_PLAYER2, MESHNUM_GUN, MESHNUM_SPECIALGUN, MESHNUM_FLOOR1, MESHNUM_FLOOR2, MESHNUM_FLOOR3, MESHNUM_BOOK1, MESHNUM_BOOK2, MESHNUM_BOOK3,
			   ...
			   MESHNUM_URINAL, MESHNUM_WATERCOOLER, MESHNUM_CEILINGLIGHT, MESHNUM_FENCE, MESHNUM_CEILING, MESHNUM_SPHERE, MESHNUM_TOWER, MESHNUM_CARBOARDBOX, 
			   MESHNUM_JANITORCART,  MESHNUM_MAGAZINES,	MESHNUM_FIREEXTINGUISHER, MESHNUM_CLIPBOARD, MESHNUM_PAPERGROUP, MESHNUM_PAPERS, MESHNUM_WHITEBOARD, MESHNUM_CARBOARDBOX2, MESHNUM_POWEROUTLETMULTI, MESHNUM_LAPTOP, MESHNUM_FILEBOX1, MESHNUM_FILEBOX2, MESHNUM_END };
