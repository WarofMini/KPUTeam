...
enum MESHNUM { MESHNUM_PLAYER, MESHNUM_FLOOR1, MESHNUM_FLOOR2, MESHNUM_FLOOR3, MESHNUM_BOOK1, MESHNUM_BOOK2, MESHNUM_BOOK3, 
			   MESHNUM_BOOKBOX1, MESHNUM_BOOKBOX2, MESHNUM_CABINET1, MESHNUM_CABINET2,
			   MESHNUM_CHAIR1, MESHNUM_CHARI2, MESHNUM_CHAIR3, MESHNUM_CHAIR4, 
			   ...
			   MESHNUM_URINAL, MESHNUM_WATERCOOLER, MESHNUM_END };
