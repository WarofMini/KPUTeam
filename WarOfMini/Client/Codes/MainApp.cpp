...
HRESULT CMainApp::Initialize(void)
{
	...
	CResourcesMgr::GetInstance()->Ready_Buffer(pGraphicDev, pContext, RESOURCE_STAGE, CResourcesMgr::BUFFER_FLAGTEX, L"Buffer_FlagTexOne", 20, 20, 40, 20);
	CResourcesMgr::GetInstance()->Ready_Buffer(pGraphicDev, pContext, RESOURCE_STAGE, CResourcesMgr::BUFFER_FLAGTEX, L"Buffer_FlagTexTwo", 20, 20, 40, 20);
...
void CMainApp::Render(void)
{
	...
	if(g_strFullPath != L"")
		CFontMgr::GetInstance()->Render_Font(L"고딕", g_strFullPath.c_str(), 15.f, 220.f, 870.f, D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.f));
...
void CMainApp::Stage_DebugInfo(void)
{
	...
	CFontMgr::GetInstance()->Render_Font(L"고딕", L"F4 : 화면크기 조절", 15.f, 10.f, 275.f, D3DXCOLOR(0.0f, 1.0f, 0.f, 1.f));

	CFontMgr::GetInstance()->Render_Font(L"고딕", L"K : 렌더타겟 On/Off", 15.f, 10.f, 295.f, D3DXCOLOR(0.0f, 1.0f, 0.f, 1.f));
