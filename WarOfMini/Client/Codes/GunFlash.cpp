...
CGunFlash * CGunFlash::Create(ID3D11DeviceContext * pContext)
{
	CGunFlash* pEffect = new CGunFlash(pContext);
...
HRESULT CGunFlash::Initialize(void)
{
...
void CGunFlash::Release(void)
{
	CEffect::Release();
}

HRESULT CGunFlash::Ready_Component(void)
{
	...
	//Texture
	pComponent = CResourcesMgr::GetInstance()->Clone_ResourceMgr(RESOURCE_STAGE, L"Texture_GunFlash");
